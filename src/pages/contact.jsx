  ...
  return (
    <Box sx={{ mt: 4 }}>
      ...
      <Typography style={{ color: "white" }} gutterBottom>
        We welcome your questions, feedback, and participation! Whether you're a
        devotee, volunteer, sponsor, or visitor, feel free to reach out to us.
      </Typography>
      ...
      <Typography style={{ color: "white" }} sx={{ mt: 2 }}>
        ...
        Instagram:{" "}
        <Link
          href="https://instagram.com/riddhisiddhiganeshfoundation"
          target="_blank"
        >
          riddhisiddhiganesh
        </Link>
        ...
        YouTube:{" "}
        <Link
          href="https://youtube.com/@riddhisiddhiganeshfoundation"
          target="_blank"
        >
          @riddhisiddhiganesh
        </Link>
      ...
      <Typography style={{ color: "white" }} sx={{ mt: 3 }}>
        <em>
          🙏 Let us stay connected in devotion and service to Lord Ganesha.
        </em>
      </Typography>
    </Box>
  );
